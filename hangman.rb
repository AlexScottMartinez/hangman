...
module Files
  ...
  def sample_word_list
    File.readlines('./google-10000-english-no-swears.txt').select { |word| word.length > 5 && word.length < 14 }.sample.chomp.upcase.split('')
  end
...
class Game
  ...
  def new_game
    ...
    if new_game == 'y'
      ...
      puts abort('Thanks for playing! Go learn some more names of birds, beasts and fishes! See you back soon!')
    end
  end
end
